  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        activeIcon: Icon(FluentSystemIcons.ic_fluent_book_formula_database_regular),label: "search"),
        BottomNavigationBarItem(icon: Icon(FluentSystemIcons.ic_fluent_open_filled),
        activeIcon: Icon(FluentSystemIcons.ic_fluent_open_filled),label: "ticket"),
